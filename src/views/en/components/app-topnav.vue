...
const { user } = useStore()
const { is_login, userInfo } = storeToRefs(user)
//动态获取窗口大小
    ...
    <div class="navbar-inner">
      <div class="container1">
            ...
            <div class="drawer" :class="{ open: isDrawerOpen }">
              <div class="drawer-content1">
                <ul v-for="(item, index) in drawerItems1" :key="item">
                  <li v-if="index === 0" :style="getItemStyle(index)" class="drawer-item1">
                    {{ item }}
                  </li>
                  <li v-if="index === 1">
                    {{ item }}
                  </li>
                  <li v-if="index === 2" :style="getItemStyle(index)" class="drawer-item1">
                    {{ item }}
                  </li>
                  <li v-if="index === 3">
                    {{ item }}
              ...
              <div class="drawer-content">
                <ul v-for="(item, index) in drawerItems" :key="item">
                  <li :style="getItemStyle(index)" class="drawer-item" v-if="index === 0">
                    {{ item }}
                  </li>
                  <li :style="getItemStyle(index)" class="drawer-item" v-if="index === 1">
                    {{ item }}
                  </li>
                  <li :style="getItemStyle(index)" class="drawer-item" v-if="index === 2">
                    {{ item }}
                  </li>
                  <li v-if="index === 3">
                    {{ item }}
        ...
        <div v-if="windowWidth < 810" class="logoMobile" style="z-index: 1000">
          <img src="https://framerusercontent.com/images/tPARp861sam7uMlfJzybvdYO5c.svg" alt="" />
        </div>
        <div class="left-side" v-else>
          <router-link to="/">
            <div class="logo">
              <img src="https://framerusercontent.com/images/KzmEYJoH5H584cEIyvf1sjE69A.svg" alt="BeWater" />
            </div>
          </router-link>

          <div>
            <span class="nav-items">
              <router-link v-for="(item, index) in navItems" :key="index" class="nav-item" :to="item.router">
                {{ item.path }}
              </router-link>
            </span>
          </div>
        ...
        <div v-if="!is_login" class="right_menu">
          <svg t="1736757224865" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="1754" width="26" height="26">
            <path
          ...
          <div class="user_menu" v-if="show" id="modal234351">
            ...
            <div class="other_set">
              ...
              <div class="item active_hover" @click="router.push('/host'), (show = false)">
                <div class="left_icon">
                  <svg t="1736758153110" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="1908" width="22" height="22">
                    <path
...
.drawer-content1 {
  ...
  'Basement Grotesque Bold Placeholder',
  sans-serif;
  font-size: 32px;
